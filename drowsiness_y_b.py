        ...
        if results.multi_face_landmarks:
            ...
            if  (mar_ratio > 0.7) :
                ...
                if (counter_m > 3) & (total >= fps * 5 ):
                    swift_speak("Please take a break, You are drowsy")
                    cv.putText(image, 'You are drowsy!', (100, 30), cv.FONT_HERSHEY_COMPLEX, 0.7, (255, 255, 255, 255), 1)
                    drowsy_detected += 1
                    total = 0
                    counter_m = 0
                elif (total >= fps *5 ):
            ...
            cv.putText(image, f'{drowsy_detected} Drowsiness detected', (350, 30), cv.FONT_HERSHEY_COMPLEX, 0.7, (255, 255, 255, 255), 1)
